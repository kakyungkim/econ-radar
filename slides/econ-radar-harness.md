...
<span class="small">매일 + 주간 자동 발행 · 블로그, 텔레그램, 이메일 3채널</span>
...
| **3층 (저술)** | 쌓인 기록에서 패턴 추출 | 동향 리포트, 블로그, 책 | **주간 동향 공개 발행** |

<br>

- 1층은 **매일 돌아가고**, 2층은 **그날의 기록을 주제별로 잇고**, 3층은 **매주 월요일 아침에 한 주를 정리해 공개 발행한다.**
...
| **주간 동향** | 월요일 08:00 KST | 한 주를 엮어 블로그·텔레그램·이메일로 공개 발행(3층) |
